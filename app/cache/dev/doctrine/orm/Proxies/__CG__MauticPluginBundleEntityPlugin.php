...
class Plugin extends \Mautic\PluginBundle\Entity\Plugin implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mautic\\PluginBundle\\Entity\\Plugin' . "\0" . 'id', '' . "\0" . 'Mautic\\PluginBundle\\Entity\\Plugin' . "\0" . 'name', '' . "\0" . 'Mautic\\PluginBundle\\Entity\\Plugin' . "\0" . 'description', '' . "\0" . 'Mautic\\PluginBundle\\Entity\\Plugin' . "\0" . 'isMissing', '' . "\0" . 'Mautic\\PluginBundle\\Entity\\Plugin' . "\0" . 'bundle', '' . "\0" . 'Mautic\\PluginBundle\\Entity\\Plugin' . "\0" . 'version', '' . "\0" . 'Mautic\\PluginBundle\\Entity\\Plugin' . "\0" . 'author', '' . "\0" . 'Mautic\\PluginBundle\\Entity\\Plugin' . "\0" . 'integrations', 'changes');
        }
